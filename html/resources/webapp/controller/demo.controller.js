sap.ui.define([
	"fypforecast/html/base/Controller"
], function(Controller) {
	"use strict";
	return Controller.extend("fypforecast.html.controller.demo", {
		onInit: function() {
		...
		onPressPopover: function(oEvent) {
			...
			if (!this.oPopoverExtraPredictor) {
				this.oPopoverExtraPredictor = sap.ui.xmlfragment("fypforecast.html.fragment.data." + dataset, this);
